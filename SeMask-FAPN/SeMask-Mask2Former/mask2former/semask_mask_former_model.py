...
from .modeling.criterion import SeMaskSetCriterion
from .modeling.matcher import HungarianMatcher


@META_ARCH_REGISTRY.register()
class SeMaskMaskFormer(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        cate_weight = cfg.MODEL.MASK_FORMER.CATE_WEIGHT
        ...
        weight_dict = {"loss_ce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight, "loss_cate": cate_weight}
    ...
    def prepare_targets(self, targets, gt_seg_targets, images):
        ...
        new_targets = []
        for targets_per_image, gt_seg_target_per_image in zip(targets, gt_seg_targets):
            # pad gt
