...
class DCN(DCNv2):
    ...
    def forward(self, input, main_path=None):
        ...
        return dcn_v2_conv(input.float(), offset.float(), mask.float(), self.weight.float(), self.bias.float(), self.stride, self.padding, self.dilation, self.deformable_groups,)
